...
iname=${DOCKER_IMAGE:-"ibis/grsim-nvidia"} ## name of image (should be same as in build.sh)
cname=${DOCKER_CONTAINER:-"grsim-nvidia"} ## name of container (should be same as in exec.sh)
